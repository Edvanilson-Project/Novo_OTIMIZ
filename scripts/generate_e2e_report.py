...
def main():
    ...
    with open("operational_time_e2e_runtime_validation_report.md", "w") as out:
        ...
        out.write("\n## Contagem por Event Scope (CSV)\n")
        for k, v in event_scopes.items():
            out.write(f"- {k}: {v}\n")
        ...
        out.write("\n## Veredito Final\n")
        out.write("**PRONTO**. O pipeline de otimização está calculando e extraindo semanticamente todos os eventos, gravando nas colunas metadados do PostgreSQL com snake_case e refletindo no DTO do latest-schedule.\n")
